    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li><a href="indexww.php">Home</a></li>
          <li class="selected"><a href="kirimberitaww.php">Kirim Berita</a></li>
        </ul>
      </div>
    </div>
...
<h3>Useful Links</h3>
       ...
       <div id="content">
          <h2>Upload Berita</h2>
            <p>File yang bisa di Upload hanya file dengan ekstensi <b>hanya .rar, .zip</b> dan besar file (file size) maksimal hanya 50 MB.</p>
