    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><a href="updateberitapr.php">Update Berita</a></li>
...
<h3>Useful Links</h3>
       ...
       <div id="content">
          <h2>Upload Berita</h2>
            <p>halam ini untuk melakukan <b>Update</b> berita yang telah di upload oleh wartawan dan besar file (file size) maksimal hanya 50 MB.</p>
