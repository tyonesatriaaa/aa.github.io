    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><a href="updateberitaadm.php">Update Berita</a></li>
...
<h3>Useful Links</h3>
       ...
       <div id="content">
          <h2>Upload Berita</h2>
            <p>halam ini untuk melakukan <b>Update</b> berita yang telah di upload oleh wartawan dan besar file (file size) maksimal hanya 100 MB.</p>
            <b>Format nama harus diberi nama (update) di belakang</b>.
            <?php
      ...
      if(@$_POST['upload']){
        ...
        if(in_array($eksfile, $allowed_ext) === true){
          if($file_size < 50000000){
            $lokasi = 'files1/'.$nama.'.'.$eksfile;
            move_uploaded_file($file_tmp, $lokasi);
            $in = mysqli_query($koneksi, "INSERT INTO download1 VALUES(NULL, '$tgl', '$nama', '$eksfile', '$file_size', '$lokasi')");
            if($in){
